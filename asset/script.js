...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const schoolKnowledge = {
        ...
        contact: {
            ...
            response: "📞 <strong>Phone:</strong> (201) 222-1116<br>📧 <strong>Email:</strong> info@stbernadine.com<br>📍 <strong>Visit:</strong> 591 Summit Ave, Jersey City.<br><br>We are here to help!"
        },
        referral: {
