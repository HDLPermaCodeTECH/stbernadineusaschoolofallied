...
const moreLink = '<li><a href="services.html#certification-programs">More <i class="fa-solid fa-arrow-right"></i></a></li>';
...
files.forEach(file => {
    ...
    content = content.replace(regex, (match, prefix, listContent, suffix) => {
        ...
        if (!newListContent.includes('services.html#certification-programs')) {
